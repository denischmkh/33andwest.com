...
url = 'https://www.murraychalmers.com/clients/'
website_link = 'https://www.murraychalmers.com'
agency_name = 'murraychalmers.com'
...
# //div[@id="music_tab"]//ul[@class="artist_list"]/li/a
artists = soup.find('div', id="music_tab").find('ul', class_="artist_list").find_all('a')
