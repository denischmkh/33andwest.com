...
url = f"https://www.anna-agency.nl/"
website_link = 'https://www.anna-agency.nl'
agency_name = 'anna-agency.nl'
...
def parse120():
    ...
    if response.status_code == 200:
        ...
        artists = soup.find("div",class_="article-home").find_all("ul")
        for ul in artists:
