...
url = f"https://www.mickmgmt.com/artists"
website_link = 'https://www.mickmgmt.com'
agency_name = 'mickmgmt.com'
...
def parse111(driver):
    ...
    artists = soup.find_all("div",class_="project-title")
    for art in artists:
        text = art.text.strip()
        #print(f"Name: {text}")
