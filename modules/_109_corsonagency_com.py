...
url = f"https://corsonagency.com/"
website_link = 'https://corsonagency.com'
agency_name = 'corsonagency.com'
...
def parse109(driver):
    ...
    #print(soup)
    artists = soup.find("div",class_="artist-wrapper").find_all("div")
    for art in artists:
        text = art.text.strip()
        #print(f"Name: {text}")
