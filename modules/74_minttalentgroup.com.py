...
url = f"https://www.minttalentgroup.com/roster"
website_link = 'https://www.minttalentgroup.com'
agency_name = 'minttalentgroup.com'
...
if response.status_code == 200:
    ...
    artists = soup.find_all("figure",class_="gallery-grid-item has-clickthrough")
