...
url = f"https://tbaagency.com/roster/"
website_link = 'https://tbaagency.com'
agency_name = 'tbaagency.com'
...
def parse82():
    ...
    if response.status_code == 200:
        ...
        artists = soup.find_all("div",class_="row-cells column")
        for div in artists:
        ...
        artists1 = soup.find_all("div", class_="row-cells")
        for div1 in artists1:
            li_all1 = div1.find_all("li")
            for art in li_all1:
                text = art.text.strip()
                #print(f"Name: {text}")
                current_names.add(text)
