url = 'https://xraytouring.com/'
website_link = 'https://xraytouring.com'
...
def parse19(driver):
    ...
    all_links = driver.find_elements(By.XPATH, '//div[@class="list-content-grid"]//li[not(b)]')
