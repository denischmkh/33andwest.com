...
url = f"https://hometown-talent.com/"
website_link = 'https://hometown-talent.com'
agency_name = 'hometown-talent.com'
...
def parse101():
    ...
    if response.status_code == 200:
        ...
        sections_all = soup.find("section", id="artists-content").find_all("div", recursive=True)[2]
        section = sections_all.find_all("section")
        for section in section:
            div = section.find("div")
            div_all = div.find_all("div", attrs={"data-element_type": "column"})
            for art in div_all:
                text = art.text.strip()
                #print(f"Name: {text}")
