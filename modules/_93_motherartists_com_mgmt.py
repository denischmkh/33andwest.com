...
url = f"https://www.motherartists.com/management/"
website_link = 'https://www.motherartists.com/management'
...
def parse93():
    ...
    if response.status_code == 200:
        ...
        artists = soup.find("div",class_="artists-wrap").find_all("div")
        artist = artists[0].find_all("div",class_="col-md-4")
        for art in artist:
            dt = art.find("dt")
            text = dt.text.strip()
            #print(f"Name: {text}")
