...
url = f"https://www.tap-music.com/management"
website_link = 'https://www.tap-music.com'
agency_name = 'tap-music.com'
...
def parse105(driver):
    ...
    #print(soup)
    artists = soup.find_all("li",class_="talent-li")
    for art in artists:
        text = art.text.strip()
        #print(f"Name: {text}")
