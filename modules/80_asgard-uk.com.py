...
url = f"https://www.asgard-uk.com/"
website_link = 'https://www.asgard-uk.com'
agency_name = 'asgard-uk.com'
...
if response.status_code == 200:
    ...
    artists = soup.find_all("td",attrs={"width":"320","class":"artisttext"})
    for td in artists:
        p = td.find_all("p")
        for art in p:
            text = art.text.strip()
