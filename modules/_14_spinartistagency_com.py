...
def parse14():
    ...
    url = 'https://www.spinartistagency.com/roster'
    website_link = 'https://www.spinartistagency.com'
    ...
    lost = []
    artists = soup.find('section', class_="Main-content").find('div', class_="row sqs-row").find_all('a')
    for a in artists:
        text = a.get_text()
        if text != " ":
