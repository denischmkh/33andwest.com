...
url = f"https://www.rcarecords.com/"
website_link = 'https://www.rcarecords.com'
agency_name = 'rcarecords.com'
...
def parse96():
    ...
    if response.status_code == 200:
        ...
        artists = soup.find("ul",class_="artists-list-scroll").find_all("li")
