...
url = f"https://radiusartists.com/"
website_link = 'https://radiusartists.com'
agency_name = 'radiusartists.com'
...
artists = soup.find_all("article",class_="mix default mix_all")
