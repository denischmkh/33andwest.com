...
url = f"https://culturewave.la/artists/"
website_link = 'https://culturewave.la'
agency_name = 'culturewave.la'
...
#print(soup)
artists = soup.find_all("p",attrs={"itemprop":"name"})
for art in artists:
    text = art.text.strip()
    #print(f"Name: {text}")
