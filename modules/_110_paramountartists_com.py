...
url = f"https://paramountartists.com/agent"
website_link = 'https://paramountartists.com'
agency_name = 'paramountartists.com'
...
def parse110(driver):
    ...
    #print(soup)
    artists = soup.find("aside",class_="list").find("div").find_all("a")
    for art in artists:
        text = art.text.strip()
        #print(f"Name: {text}")
