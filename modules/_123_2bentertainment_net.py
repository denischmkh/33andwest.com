...
url = f"https://2bentertainment.net/"
website_link = 'https://2bentertainment.net'
agency_name = '2bentertainment.net'
...
def parse123():
    ...
    if response.status_code == 200:
        ...
        artists = soup.find_all("h2",class_="premium-blog-entry-title")
