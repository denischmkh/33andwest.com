...
url = 'https://www.billions.com/'
website_link = 'https://www.billions.com'
...
def parse4(driver: uc.Chrome):
    ...
    time.sleep(2)
    all_links = find_elemets_on_page('//div[@data-hook="info-element"]//span')
