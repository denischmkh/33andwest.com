...
url = f"https://www.panacherock.com/"
website_link = 'https://www.panacherock.com'
agency_name = 'panacherock.com'
...
def parse140():
    ...
    if response.status_code == 200:
        ...
        artists = soup.find_all("div",class_="row row-cols-1 row-cols-sm-2 row-cols-md-3 justify-content-center panache-grid")
        div_all = artists[0].find_all("div",class_="col pb-5")
        for div in div_all:
