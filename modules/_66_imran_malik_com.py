...
url = f"http://www.imran-malik.com/im-publicity/"
website_link = 'http://www.imran-malik.com'
agency_name = 'imran-malik.com'
...
def parse66():
    ...
    if response.status_code == 200:
        ...
        artists = soup.find_all("div",class_="text-below")
