...
url = f"https://warmagency.com/"
website_link = 'https://warmagency.com'
agency_name = 'warmagency.com'
...
def parse108():
    ...
    if response.status_code == 200:
        ...
        artists = soup.find("ul",class_="roster-list").find_all("li")
