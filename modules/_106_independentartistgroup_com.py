...
url = f"https://independentartistgroup.com/global-touring/global-touring-roster/"
website_link = 'https://independentartistgroup.com'
agency_name = 'independentartistgroup.com'
...
def parse106():
    ...
    if response.status_code == 200:
        ...
        for art in artists:
            if stop:
                break
            a_all = art.find_all("a")
            for a in a_all:
                text = a.text.strip()
                if text=="Booking Form":
                    stop = True
                    break
                #print(f"Name: {text}")
        ...
        for name in current_names:
            artist, created = Artist.objects.get_or_create(
                ...
                defaults={
                    'agency_name': 'independentartistgroup',
                    'date_added': today
                }
            )
