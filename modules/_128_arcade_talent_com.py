...
url = f"https://www.arcade-talent.com/"
website_link = 'https://www.arcade-talent.com'
agency_name = 'arcade-talent.com'
...
def parse128(driver):
    ...
    #print(soup)
    artists = soup.find_all("div",class_="artist-item")
