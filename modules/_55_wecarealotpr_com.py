...
url = f"http://www.wecarealotpr.com/"
website_link = 'http://www.wecarealotpr.com'
agency_name = 'wecarealotpr.com'
...
def parse55():
    ...
    if response.status_code == 200:
        ...
        artists = soup.find("ul",id="menu-artists-menu").find_all("li")
